...
# draw class which stores data regarding the lottery draws in the database
class Draw(db.Model):
    __tablename__ = 'draws'
...
# storing the details of an admin user in the database
def init_db():
    db.drop_all()
    db.create_all()
